...
function beautyV1(res, baseCell, children) {
    // console.log('res = ', res);

    // console.log('base = ', baseCell);
...
function isEqualLevel(cell, nextCell) {
    if (cell.tech !== nextCell.tech) {
        return false;
    }

    if (cell.entity.block !== nextCell.entity.block) {
        return false;
    }

    if ((!cell.entity.elem && nextCell.entity.elem) || (!cell.entity.mod && nextCell.entity.mod)) {
        return false;
    }
...
function isDeeperLevel(cell, nextCell) {
    if (cell.tech !== nextCell.tech) {
        return false;
    }

    return nextCell.entity.belongsTo(cell.entity);
}
...
module.exports = function (decl) {
    ...
    return group(decl, beautyV1, isEqualLevel, isDeeperLevel);
